...
function Instructions() {
  return (
    <div className="instructions card" style={{ marginBottom: 24 }}>
      ...
      <ol>
        <li>Connect your MetaMask wallet (make sure you are on the <b>Sepolia</b> testnet).
          <br />
          <b>Note:</b> To test this demo you will need ETH in your wallet. Here is a faucet where you can get ETH: <a href='https://faucet.polygon.technology/'>https://faucet.polygon.technology/</a></li>
